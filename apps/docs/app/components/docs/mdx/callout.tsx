...
const calloutStyles = {
  info: {
    container: 'bg-[#14181a] border-[rgba(20,199,123,0.24)]',
    icon: 'text-[#28e98f]',
    title: 'text-[#f1f4f2]',
    content: 'text-[#c7d0d5]',
  },
  tip: {
    container: 'bg-[rgba(20,199,123,0.08)] border-[rgba(20,199,123,0.28)]',
    icon: 'text-[#28e98f]',
    title: 'text-[#f1f4f2]',
    content: 'text-[#c8ffe8]',
  },
  warning: {
    container: 'bg-[#14181a] border-[rgba(240,180,41,0.28)]',
    icon: 'text-[#f0b429]',
    title: 'text-[#f1f4f2]',
    content: 'text-[#d8d0b6]',
  },
  note: {
    container: 'bg-[#14181a] border-[rgba(148,163,184,0.18)]',
    icon: 'text-[#a4adb3]',
    title: 'text-[#f1f4f2]',
    content: 'text-[#c7d0d5]',
  },
