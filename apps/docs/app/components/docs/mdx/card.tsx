...
export function Card({ title, icon, image, href, children }: CardProps) {
  ...
  const content = (
    <div
      className={cn(
        'group block h-full rounded-lg border border-[rgba(148,163,184,0.14)] bg-[#14181a] p-6',
        'transition-all duration-200 hover:border-[rgba(20,199,123,0.28)] hover:bg-[#181d1f]',
        href && 'cursor-pointer'
      )}
    >
      {image ? (
