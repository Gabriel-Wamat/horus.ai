    ...
    <>
      <button
        ...
        className={cn(
          ...
          'bg-[#181d1f] border border-[#262c30]',
          'text-sm text-[#6f7a80] hover:text-[#f1f4f2] hover:bg-[#20262a] hover:border-[rgba(255,255,255,0.12)]',
          'transition-all'
        )}
      >
        <SearchIcon className="w-4 h-4 shrink-0" />
        <span className="flex-1 text-left">Search documentation...</span>
        <kbd className="hidden sm:inline-flex items-center gap-1 px-2 py-1 rounded bg-[#0f1314] text-xs font-mono text-[#6f7a80] border border-[rgba(148,163,184,0.14)]">
          <span>⌘</span>K
        </kbd>
      </button>
...
function SearchDialog({ onClose }: SearchDialogProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-[#111719] border border-[#262c30] rounded-xl shadow-2xl overflow-hidden">
          ...
          <div className="flex items-center gap-3 px-4 border-b border-border">
            ...
            <input
              ...
              autoFocus
            />
            <kbd className="px-2 py-1 rounded bg-[#181d1f] text-xs text-[#6f7a80] font-mono border border-[#262c30]">
              ESC
            </kbd>
          </div>
          ...
          {results.length > 0 && (
            <div className="flex items-center gap-4 px-4 py-2 border-t border-[#262c30] bg-[#0f1314] text-xs text-[#6f7a80]">
