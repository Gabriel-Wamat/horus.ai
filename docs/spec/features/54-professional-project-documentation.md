...
validation_protocol:
  required_static_checks:
    ...
    - command: "test -f docs/architecture.md && test -f docs/runbook.md && test -f docs/configuration.md && test -f docs/chronology.md && test -f docs/contributing.md"
      ...
      success_condition: "Exit code 0."
    - command: "rg -n '/Users/wamat|/Users/|C:\\\\Users|/home/[^ ]+' README.md docs"
      cwd: "<repo-root>"
...
implementation_log:
  ...
  validation:
    ...
    - command: "rg -n '/Users/wamat|/Users/|C:\\\\Users|/home/[^ ]+' README.md docs --glob '!docs/specs/**'"
    ...
    - command: "rg -n '/Users/wamat|/Users/|C:\\\\Users|/home/[^ ]+' README.md docs/index.md docs/architecture.md docs/runbook.md docs/configuration.md docs/chronology.md docs/contributing.md"
